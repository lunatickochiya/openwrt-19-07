...
function index()
	...
	entry( {"admin", "services", "amule", "startstop"}, call("startstop") ).leaf = true
	entry( {"admin", "services", "amule", "down_kad"}, call("down_kad") ).leaf = true
	entry( {"admin", "services", "amule", "down_ed2k"}, call("down_ed2k") ).leaf = true
