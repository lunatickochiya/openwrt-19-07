...
if SYS.call("iptables-save | grep ADBYBY >/dev/null") == 0 then
	...
	o.inputstyle = "reset"
	o.description = translate("<strong><font color=\"red\">Do not update the rules when Adbyby is not running, otherwise the rules file will take up space!</font></strong><br /><strong><font color=\"red\">In 25 Seconds will update rules when Adbyby started, do not manually update rules!</font></strong>")
	o.write = function()
...
o.inputstyle = "reload"
o.write = function()
	SYS.call("sh /usr/share/adbyby/adupdate.sh > /tmp/adupdate.log 2>&1 &")
	SYS.call("sleep 4")
	HTTP.redirect(DISP.build_url("admin", "services", "adbyby"))
end
